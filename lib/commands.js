  ...
  // Store channel ID's and Strip special characters
    ...
    .then((result) => {
      ...
      if (users_in_help[user].status) {
        console.log(/<#C1MCA2P9V> past 4 days/.exec(text), "  trying to help out")
        username = "recaptain";
        if (users_in_help[user].index == 1 && /<#C1MCA2P9V>/.exec(text)) {
        ...
        else if (users_in_help[user].index == 2 && /<#C1MCA2P9V> past 4 days/.exec(text)) {
        ...
        else if (help_status.index == 3 && /<#C1MCA2P9V> food/.exec(text)) {
