...
function parseDate(text) {
  console.log("Lets look at parseDate")
  console.log(text)
  console.log()
  ...
  const regexes = [
    ...
    [/past\s(?:days|day|d)/i, (res) => moment().subtract(1, 'days')],
    [/past\s(\d+)\s(?:days|day|d)/i, (res) => moment().subtract(res[1], 'days')],
    [/past\s(?:weeks|week|w)/i, (res) => moment().subtract(1, 'weeks')],
    [/past\s(\d+)\s(?:weeks|week|w)/i, (res) => moment().subtract(res[1], 'weeks')]
  ];
